...
async function prefetchCommentsCountForCurrentItem(options = {}) {
    ...
    const requestId = galleryState.commentsCountRequestId + 1;
    galleryState.commentsCountRequestId = requestId;
    ...
    try {
        ...
        if (requestId !== galleryState.commentsCountRequestId) {
            return;
        }
        ...
        console.warn('Gallery comments count failed to preload:', error);
        setCommentsCount(0);
    }
}
